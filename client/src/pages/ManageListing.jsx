            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 mt-2">
                        {isEditing ? "Update your existing acount listing" : "Create a mock listing to display your account info"}
                    </p>
                </div>
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <Section title={"Account Metrics"}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <InputField label={"Primary Audiance Country"} placeholder={"United States"} value={formData.country} onChange={(v) => handleInputChange('country', v)} />
                    ...
                    <Section title={"Pricing & Description"}>
                        <InputField label={"Asking Price (USD)"} type="number" placeholder={"2500.00"} min={0} value={formData.price} onChange={(v) => handleInputChange('price', v)} required={true} />
                        <TextareaField label={"Description"} value={formData.description} onChange={(v) => handleInputChange('description', v)}
                            required={true} />
                    </Section>
