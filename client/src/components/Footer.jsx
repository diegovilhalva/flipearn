    ...
    <footer className="mt-32 px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          <a href="/" aria-label="FlipEarn homepage">
            <img src={assets.logo} alt="FlipEarn Logo" />
          </a>
          <p className="text-sm/7 mt-6">
            FlipEarn is a leading social media marketplace that connects brands 
            and creators through a secure and user-friendly platform.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="text-sm space-y-6 max-w-sm">
            <p>The latest news, articles, and resources — delivered weekly.</p>
      ...
      <p className="py-4 text-center border-t mt-6 border-slate-200">
        Copyright 2025 © Diego Vilhalva. All Rights Reserved.
      </p>
    </footer>
  );
};
